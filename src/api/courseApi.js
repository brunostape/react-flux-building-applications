...
var CourseApi = {
	...
	hasCourseWithThisCategory: function (categoryId) {
		var _result = _.find(courses, { categoryId: categoryId });
		return _result !== undefined;
	},
	
	hasCourseWithThisAuthor: function (authorId) {
		var _result = _.find(courses, { authorId: authorId });
		return _result !== undefined;
	},
